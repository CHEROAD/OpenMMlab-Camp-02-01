...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        draw=True,
        test_out_dir=
        'D:\\\\code\\\\python\\\\mmtutorials\\\\mmdetection-tutorials\\\\work_dirs\\\\ballon\\\\test\\\\showdir'
    ))
env_cfg = dict(
...
log_level = 'INFO'
load_from = 'work_dirs\\ballon\\best_coco_bbox_mAP_epoch_20.pth'
resume = False
train_cfg = dict(
